...
export default function Process() {
  ...
  return (
    <section id="process" className="py-24 px-6" style={{ background: 'var(--bg-secondary)' }}>
      <div className="max-w-5xl mx-auto">
        ...
        <div className="relative">
          ...
          >
            ...
            <line x1="1" y1="0" x2="1" y2={lineLength} stroke="var(--accent-electric)" strokeWidth="2" strokeDasharray="8 6"
              ...
              return (
                ...
                >
                  <div className="relative z-10 w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold shrink-0 md:absolute md:left-1/2 md:-translate-x-1/2"
                    style={{ background: 'var(--accent-electric)', color: '#fff', boxShadow: '0 0 0 4px var(--bg-secondary)' }}
                  >
                    {s.num}
                  </div>
