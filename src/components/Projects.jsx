...
const tabs = [
  { id: 1, label: 'مواقع الشركات' },
  { id: 2, label: 'متاجر إلكترونية' },
  { id: 3, label: 'مواقع سياحية' },
  { id: 4, label: 'مواقع تعليمية' },
  { id: 5, label: 'تطبيقات الهاتف' },
]
  ...
  return (
    <section className="projects-section">
      <div className="e-con-inner">
        <div className="section-heading-wrapper animated fadeInUp">
          <h3 className="sub-title"><span className="style-gradient">أحدث مشاريعنا</span></h3>
          <h2 className="main-title">mmm <span className="style-gradient">projects</span></h2>
          <p className="description">نقدم أفضل الحلول والعروض المتاحة لتصميم وتطوير المواقع والتطبيقات</p>
        </div>

        <div className="n-tabs-wrapper animated fadeInUp">
